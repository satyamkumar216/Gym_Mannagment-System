...
function StaffLogin() {
  ...
  return (
    <div className="relative min-h-screen w-full bg-[#050505] flex items-center justify-center overflow-hidden select-none p-4 sm:p-6 md:p-8">
      ...
      {/* Back to main site link (Top Left of screen) */}
      ...
      <div className="w-full max-w-sm space-y-6 relative z-20">
        <div className="text-center">
          <div className="inline-flex h-14 w-14 rounded-2xl bg-[#E02020] items-center justify-center shadow-lg shadow-[#E02020]/25 transition-transform hover:scale-105">
        ...
        >
          {/* Card with red left border accent, semi-transparent background */}
          <div className="rounded-2xl bg-[#111111]/85 border border-[#222222] border-l-4 border-l-[#E02020] p-6 md:p-8 shadow-2xl relative backdrop-blur-md">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    required
                    className="pl-10 bg-black/40 border-[#222222] h-11 focus-visible:ring-[#E02020] text-sm"
                  />
                </div>
              </div>
